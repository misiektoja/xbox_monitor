...
_STARTUP_GLOBALS = tuple(sorted(monitor._config_allowed_names())) + ("CLI_CONFIG_PATH", "EXPORTED_SECRET_KEYS", "LIVENESS_CHECK_COUNTER", "XBOX_AUTH_REFRESH_VERSION", "STDOUT_AT_START_OF_LINE")
